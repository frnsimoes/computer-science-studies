...
class CSVFileScan:
    ...
    def next(self):
        ...
        try:
            # return tuple(t(v) for t, v in zip(schema, next(self.reader)))
            return tuple(_type(value) for value, _type in zip(next(self.reader), self.schema))
...
if __name__ == '__main__':
    ...
    reader = CSVFileScan("/home/frns/Downloads/ml-20m/movies.csv", movies_schema)
    print(tuple(run(Q(
        Limit(9),
        Selection(lambda x: x[0] == 69),
        reader))))
